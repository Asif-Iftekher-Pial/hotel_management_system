            ...
            <div class="col-md-12">
                <div class="profile-header">
                    <div class="row align-items-center">
                        <div class="col-auto profile-image">
                            <a href="#"> <img class="rounded-circle" alt="User Image" src="{{ asset('backend/images/employee/'.$data->image) }}"> </a>
                        </div>
                        <div class="col ml-md-n2 profile-user-info">
                            <h4 class="user-name mb-3">   {{ $data->user_name }}</h4>
                            <span>ID: {{ $data->e_id }}</span>
                            <h6 class="text-muted mt-1">{{ $data->role }}</h6>
                            <div class="user-Location mt-1"><i class="fas fa-map-marker-alt"></i>{{ $data->city }}, {{ $data->state }},
                                {{ $data->country }}</div>
                            <div class="about-text">{{ $data->address }}</div>
                        </div>
                ...
                <div class="profile-menu">
                    <ul class="nav nav-tabs nav-tabs-solid">
                        <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#per_details_tab">About</a>
                        </li>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row mt-5">
                                            ...
                                            <p class="col-sm-9">{{ $data->first_name }} {{ $data->last_name }}</p>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <p class="col-sm-9">{{ $data->contact_number }}</p>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <p class="col-sm-3 text-sm-right mb-0">Join Date</p>
